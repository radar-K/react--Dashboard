...
const Form = () => {
  ...
  return (
   <form onSubmit={handleSubmit(onSubmit)}>
    ...
    <input { ...register('name')} id="name" type="text"  className="form-control" autoComplete="name"/>
...
{/* utan Zod resolver
    <div className="mb-3"><label htmlFor="name" className="form-label">name</label>
    <input { ...register('name', {required: true, minLength: 3 })} id="name" type="text"  className="form-control" autoComplete="name"/></div>
    ...
    <div className="mb-3"> <label htmlFor="age" className="form-label">Age</label> 
    <input { ...register('age')} id="age" type="number" className="form-control"/> </div>
